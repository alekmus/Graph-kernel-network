...
def generate_EITNet():
    model = gkn.GKNet(4, 8, [128, 64, 64*4, 64*2, 64*2, 32])
    optimizer = tfk.optimizers.RMSprop(learning_rate=0.001, centered=True, momentum=0.8)
...
if __name__== '__main__':
    ...
    history = model.fit(loader.load(), 
              ...
              callbacks=[tfk.callbacks.ModelCheckpoint("weights/norm_eit_checkp",save_freq=1000)])
    #print(model.summary())
